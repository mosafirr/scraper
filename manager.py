    ...
    if a == 1:
        ...
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 11197200 , 'e569a3f232f49667be19490e6f69b8c9')
                c.start(number)
        ...
        if len(accounts) == 0:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 11197200 , 'e569a3f232f49667be19490e6f69b8c9')
                client.connect()
        ...
        webbrowser.open('https://t.me/kindevils')
        clr()
        banner()
        exit()

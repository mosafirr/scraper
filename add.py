...
for a in accounts:
    ...
    clnt = TelegramClient(f'sessions/{phn}', 11197200, 'e569a3f232f49667be19490e6f69b8c9')
    clnt.connect()
    banned = []
...
for acc in to_use:
    stop = index + 60
    c = TelegramClient(f'sessions/{acc[0]}', 11197200 , 'e569a3f232f49667be19490e6f69b8c9')
